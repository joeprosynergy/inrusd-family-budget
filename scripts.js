...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const criticalElements = { authSection, appSection, loginButton, signupButton, resetButton, logoutButton };
  ...
  function initializeFirebase() {
    ...
    try {
      ...
      if (typeof firebase === 'undefined' || !firebase.initializeApp) {
        throw new Error('Firebase SDK not loaded. Please ensure Firebase scripts are included in index.html.');
      }
